...
export class FeedController {
  ...
  @ApiOperation({
    ...
    description: 'Get a paginated feed of artworks and blog posts from users you follow. Requires authentication.',
  })
  ...
  async getFeed(
    ...
    @Query(
      'type',
      new ParseEnumPipe(FeedContentType, { optional: true }),
    )
