...
export class CreateUserDto {
  ...
  @ApiPropertyOptional({ description: 'User role', example: 'user', default: 'user' })
  @IsOptional()
  @IsString()
  role?: string;
  ...
  @ApiPropertyOptional({ description: 'User score/rating', example: 0, default: 0 })
  @IsOptional()
  score?: number;

  @ApiPropertyOptional({ description: 'Whether user is banned', default: false })
  @IsOptional()
  @IsBoolean()
  banned?: boolean;
}
