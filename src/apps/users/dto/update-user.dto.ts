...
export class UpdateUserDto extends PartialType(CreateUserDto) {
  @ApiPropertyOptional({ description: 'User full name', example: 'John Doe Updated' })
  @IsOptional()
  @IsString()
  @MinLength(2)
  @MaxLength(100)
  ...
  @ApiPropertyOptional({ description: 'User email address', example: 'john.doe.updated@example.com' })
  @IsOptional()
  @IsEmail()
  email?: string;
