...
export class FollowUserDto {
  ...
  @ApiProperty({ description: 'Number of users being followed', required: false })
  followingCount?: number;

  @ApiProperty({ description: 'Whether current user is following this user', required: false })
  isFollowing?: boolean;
}
