...
export class UploadResultDto {
  ...
  @ApiProperty({
    ...
    example: "uploads/2024/file-uuid.jpg",
  })
  objectName: string;
...
export class MultipleUploadResponseDto {
  ...
  @ApiProperty({
    ...
    example: [
      {
        fileUrl: "https://storage.example.com/file1.jpg",
        objectName: "uploads/file1.jpg",
      },
      {
        fileUrl: "https://storage.example.com/file2.jpg",
        objectName: "uploads/file2.jpg",
      },
    ],
  })
  files: Array<{
...
export class DocumentUploadResponseDto {
  ...
  @ApiProperty({
    description: "Object name in storage",
    example: "uploads/documents/file-uuid.pdf",
  })
  objectName: string;
}
