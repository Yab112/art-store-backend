...
export class PresignedUrlResponseDto {
  ...
  @ApiProperty({
    description:
      "Presigned URL for uploading file directly to S3. Use this URL with PUT method to upload the file.",
    example:
      "https://art-gallery-s3-bucket.s3.us-east-1.amazonaws.com/images/uuid.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=...",
  })
  presignedUrl: string;

  @ApiProperty({
    description:
      "Public URL of the file after upload. Use this URL to access the file after uploading.",
    example:
      "https://art-gallery-s3-bucket.s3.us-east-1.amazonaws.com/images/uuid.jpg",
  })
  publicUrl: string;
...
export class PresignedUrlItemDto {
  @ApiProperty({
    ...
    example:
      "https://art-gallery-s3-bucket.s3.us-east-1.amazonaws.com/images/uuid.jpg?X-Amz-Algorithm=...",
  })
  presignedUrl: string;
